...
export const NEWS_CARD_TEMPLATES: NewsCardTemplate[] = [
  // ── Tech Sector ──
  { id: 'tech_ai_boom', title: 'AI 혁명', description: 'AI 기술 투자 급증으로 기술주 상승세', rarity: 'rare', icon: '🤖', sector: 'tech', effects: [{ targetSector: 'tech', driftModifier: 0.03, volatilityModifier: 0.01, duration: 720 }], weight: 8, isForced: false },
  ...
  { id: 'energy_green', title: '친환경 전환', description: '재생에너지 투자 확대', rarity: 'common', icon: '🌱', sector: 'energy', effects: [{ targetSector: 'energy', driftModifier: 0.02, volatilityModifier: 0.01, duration: 720 }], weight: 18, isForced: false },
  ...
  // ── Healthcare Sector ──
  { id: 'health_pandemic', title: '팬데믹 위기', description: '신종 감염병 세계적 확산', rarity: 'legendary', icon: '🦠', sector: 'healthcare', effects: [{ targetSector: 'healthcare', driftModifier: 0.04, volatilityModifier: 0.05, duration: 720 }], weight: 3, isForced: true },
  ...
  // ── Special / Forced ──
  { id: 'special_black_monday', title: '블랙 먼데이', description: '역사적 주가 대폭락', rarity: 'legendary', icon: '⚫', effects: [{ driftModifier: -0.06, volatilityModifier: 0.06, duration: 360 }], weight: 2, isForced: true },
  ...
  // ── Additional Variety ──
  { id: 'tech_metaverse', title: '메타버스 열풍', description: '가상현실 관련 기업 주목', rarity: 'common', icon: '🥽', sector: 'tech', effects: [{ targetSector: 'tech', driftModifier: 0.02, volatilityModifier: 0.015, duration: 360 }], weight: 16, isForced: false },
  { id: 'tech_quantum', title: '양자 컴퓨팅 돌파', description: '양자 우위 달성 발표', rarity: 'rare', icon: '⚛️', sector: 'tech', effects: [{ targetSector: 'tech', driftModifier: 0.035, volatilityModifier: 0.02, duration: 540 }], weight: 5, isForced: false },
  { id: 'fin_crypto_crash', title: '암호화폐 폭락', description: '가상자산 시장 대폭락', rarity: 'uncommon', icon: '₿', sector: 'finance', effects: [{ targetSector: 'finance', driftModifier: -0.02, volatilityModifier: 0.03, duration: 360 }], weight: 12, isForced: false },
