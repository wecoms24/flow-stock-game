...
export const HISTORICAL_EVENTS: HistoricalEvent[] = [
  ...
  // ═══ 1997 ═══
  { year: 1997, month: 1, title: '한보그룹 부도', description: '한보철강이 부도처리되며 금융 불안이 시작됩니다.', type: 'crash', impact: { driftModifier: -0.12, volatilityModifier: 0.3, severity: 'high' }, duration: 100, weight: 2, affectedSectors: ['finance', 'industrial'], chainEvents: [{ templateIndex: 3, probability: 0.6, delayTicks: [50, 100] }] },
  { year: 1997, month: 3, title: '삼미·진로 등 대기업 연쇄 부도', description: '대기업 연쇄 부도로 금융권 부실이 심화됩니다.', type: 'crash', impact: { driftModifier: -0.15, volatilityModifier: 0.35, severity: 'critical' }, duration: 120, weight: 1, affectedSectors: ['finance'] },
  { year: 1997, month: 7, title: '태국 바트화 폭락, 아시아 위기 시작', description: '태국 바트화 폭락으로 아시아 금융위기가 시작됩니다.', type: 'global', impact: { driftModifier: -0.18, volatilityModifier: 0.5, severity: 'critical' }, duration: 200, weight: 1, chainEvents: [{ templateIndex: 4, probability: 0.8, delayTicks: [30, 80] }, { templateIndex: 13, probability: 0.7, delayTicks: [20, 60] }] },
  { year: 1997, month: 10, title: '외환보유고 급감', description: '원화 방어에 실패하며 외환보유고가 위험 수준으로 감소합니다.', type: 'global', impact: { driftModifier: -0.15, volatilityModifier: 0.4, severity: 'critical' }, duration: 80, weight: 1 },
  { year: 1997, month: 11, title: 'IMF 구제금융 신청', description: '한국이 IMF에 구제금융을 신청합니다. 국가 신용도 폭락.', type: 'crash', impact: { driftModifier: -0.25, volatilityModifier: 0.6, severity: 'critical' }, duration: 250, weight: 1, chainEvents: [{ templateIndex: 0, probability: 0.9, delayTicks: [10, 30] }, { templateIndex: 8, probability: 0.8, delayTicks: [50, 100] }, { templateIndex: 9, probability: 0.6, delayTicks: [100, 200] }], lessonText: '교훈: 국가도 파산할 수 있습니다. 포트폴리오의 20% 이상은 현금으로 비축하고, 과도한 레버리지를 경계하세요.' },
  { year: 1997, month: 12, title: '환율 2000원 돌파', description: '원/달러 환율이 2000원을 넘어서며 공포가 확산됩니다.', type: 'crash', impact: { driftModifier: -0.20, volatilityModifier: 0.5, severity: 'critical' }, duration: 80, weight: 1 },
