...
export const HISTORICAL_EVENTS: HistoricalEvent[] = [
  ...
  { year: 2008, month: 10, title: '글로벌 주식시장 대폭락', description: '전세계 증시가 동반 폭락, 코스피 40% 이상 하락.', type: 'crash', impact: { driftModifier: -0.22, volatilityModifier: 0.6, severity: 'critical' }, duration: 80, weight: 1 },
